...
export async function displayAssistantDashboard({ db, hideAllScreens, onLogout }) {
  const { assistantScreen, tabsContainer, contentContainer } = renderAssistantDashboardShell();
  ...
  try {
    ...
    setActiveAssistantTab(tabsContainer, ASSISTANT_DEFAULT_TAB_ID);
    renderAssistantTabContent(contentContainer, ASSISTANT_DEFAULT_TAB_ID, dashboardData);
